...
import dbmsPrompt from "../../gemini/dbmsPrompt";
...
const DBMSPage: React.FC = () => {
  ...
  // Timer hook - 12 minutes for DBMS practice
  const {
    remainingTime,
    isRunning,
    isExpired,
  ...
  const generateQuestions = useCallback(async () => {
    setIsLoading(true);
    try {
      const result = await AIchatSession.sendMessage(dbmsPrompt);
      ...
      console.error("Error generating DBMS questions:", error);
    } finally {
      setIsLoading(false);
    }
  }, [startTimer]);
    ...
    return (
      <div className="bg-gray-900 text-white min-h-screen flex items-center justify-center p-4 sm:p-8">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-300">Generating Database Management questions...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-gray-900 text-white min-h-screen p-4 sm:p-8 w-full">
        <div className="container mx-auto max-w-3xl">
          ...
          >
            ...
            <h1 className="text-3xl font-bold mb-4">DBMS Quiz Completed!</h1>
      ...
      <div className="container mx-auto max-w-3xl">
        ...
        <header className="text-center mb-10">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <h1 className="text-3xl md:text-4xl font-bold">Database Management Systems</h1>
          </div>
