...
import { Users, Target, Lightbulb, Award, ArrowRight, Star, BookOpen, Brain, Zap } from 'lucide-react';
 ...
 const values = [
    {
      ...
      description: "Democratizing interview preparation through cutting-edge AI technology"
    },
    {
      icon: <Lightbulb className="w-8 h-8" />,
      title: "Innovation First",
      description: "Continuously evolving our AI to provide the most realistic practice experience"
    },
    {
    ...
    },
    {
      ...
      title: "Excellence",
      description: "Maintaining the highest standards in AI training and educational content"
    }
  ];
...
const TextGenerateEffect: React.FC<Props> = ({ words, className }) => {
  ...
  <div className={`min-h-screen transition-colors duration-500 ${darkMode ? "bg-gray-900 text-white" : "bg-white text-gray-900"}`}>
    ...
    <section className="relative overflow-hidden py-20 px-6">
      <div className={`absolute inset-0 ${darkMode ? "bg-gradient-to-br from-blue-900/20 via-purple-900/20 to-gray-900" : "bg-gradient-to-br from-blue-100/40 via-purple-100/40 to-gray-100"}`}></div>
      <div className="relative max-w-6xl mx-auto text-center">
        ...
        <p className={`text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed ${darkMode ? "text-gray-300" : "text-gray-600"}`}>
          We're on a mission to revolutionize interview preparation through artificial intelligence, making world-class training accessible to every aspiring professional.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className={`space-y-6 text-lg ${darkMode ? "text-gray-300" : "text-gray-700"}`}>
              <p>
                PrepBuddy was born from a simple observation: too many talented individuals were missing out on 
                dream opportunities simply because they weren't prepared for the interview process.
              </p>
              <p>
                Founded in 2024 by a team of former tech executives and AI researchers, we set out to democratize 
                access to high-quality interview preparation. Our founders experienced firsthand the challenges of 
                traditional prep methods - expensive courses, limited availability, and one-size-fits-all approaches.
              </p>
              <p>
                Today, PrepBuddy combines cutting-edge artificial intelligence with proven educational methodologies 
                to create personalized, adaptive learning experiences that scale to millions of users worldwide.
              </p>
            </div>
          </div>
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-2xl blur-3xl"></div>
            <div className={`relative backdrop-blur-sm rounded-2xl p-8 border transition-colors duration-500 ${darkMode ? "bg-gray-800/50 border-gray-700" : "bg-white/80 border-gray-300"}`}>
              <div className="grid grid-cols-3 gap-6">
                <div className="text-center">
                  <Brain className="w-12 h-12 mx-auto mb-4 text-blue-400" />
                  <div className={`text-sm ${darkMode ? "text-gray-300" : "text-gray-600"}`}>AI-Powered</div>
                </div>
                <div className="text-center">
                  <Zap className="w-12 h-12 mx-auto mb-4 text-purple-400" />
                  <div className={`text-sm ${darkMode ? "text-gray-300" : "text-gray-600"}`}>Real-time</div>
                </div>
                <div className="text-center">
                  <Star className="w-12 h-12 mx-auto mb-4 text-yellow-400" />
                  <div className={`text-sm ${darkMode ? "text-gray-300" : "text-gray-600"}`}>Personalized</div>
                </div>
              </div>
            </div>
          </div>
    ...
    {/* Values Section */}
    <section className={`py-20 px-6 transition-colors duration-500 ${darkMode ? "bg-gray-800/30" : "bg-gray-50"}`}>
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-6 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
            Our Values
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, index) => (
            <div key={index} className="text-center group">
              <div className={`mb-6 inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-2xl border group-hover:from-blue-500/30 group-hover:to-purple-500/30 transition-all duration-300 ${darkMode ? "border-gray-700" : "border-gray-300"}`}>
                <div className="text-blue-400 group-hover:scale-110 transition-transform duration-300">
                  {value.icon}
                </div>
              </div>
              <h3 className={`text-xl font-semibold mb-3 ${darkMode ? "text-white" : "text-gray-900"}`}>{value.title}</h3>
    ...
    {/* CTA Section */}
    <section className={`py-20 px-6 transition-colors duration-500 ${darkMode ? "bg-gradient-to-r from-blue-900/30 to-purple-900/30" : "bg-gradient-to-r from-blue-100/50 to-purple-100/50"}`}>
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className={`text-xl mb-8 max-w-2xl mx-auto ${darkMode ? "text-gray-300" : "text-gray-600"}`}>
          Join thousands of successful candidates who've aced their interviews with PrepBuddy's AI-powered training.
        </p>
