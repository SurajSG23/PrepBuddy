const osPrompt = 
  `Generate exactly 10 multiple-choice Operating Systems questions covering core OS concepts.

Topics to cover:
- Process Management (deadlocks, scheduling algorithms, process states)
- Memory Management (paging, segmentation, virtual memory)
- File Systems (file allocation, directory structures)
...
🧠 Your task:
- Generate 10 distinct multiple-choice questions covering various OS topics above.
